export default function AddChat(input, reply) {
     ...
     const botImg = document.createElement('i')
           botImg.className = 'inline-block bi bi-robot bg-slate-100 border-2 border-green-700 px-2 py-1 rounded-full text-dark text-xl'
           botDiv.appendChild(botImg)   
     // create text element
     const botText = document.createElement('p')
           botText.className = 'inline-block bg-slate-100 border-2 border-green-700 ml-1 px-2 py-1 rounded-r-3xl rounded-tl-2xl text-dark w-4/5'
