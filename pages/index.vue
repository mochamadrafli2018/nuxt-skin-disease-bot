<template>
  <div class="bg-gradient-to-b from-slate-400 to-slate-500 quicksand">
    ...
    <main class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <h2 class="font-semibold text-black my-2 text-3xl text-center leading-7">
    ...
    <footer class="bg-slate-900 flex flex-col justify-center mt-5 p-3 text-center w-full">
